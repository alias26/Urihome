		...
		<div class="row">
			...
			<div class="col-md-1">
				...
				<nav class="col-sm-3 sidenav">
					...
					<ul>
						...
						<!-- 항목 -->
						<li><a
							href="${pageContext.request.contextPath}/member/myPageOrderList">주문내역</a></li>
						<!-- 항목 -->
			...
			<div class="col-md-10 mx-auto page">
				...
				<div class="d-flex justify-content-center mt-5"
					style="align-items: center; border: 3px solid black;">
					<!-- flex-fill은 부트스트랩에서 제공하는 flexbox속성, 해당요소가 부모 컨테이너의 남은 공간을 모두 차지하도록 설정 -->

					<div class="flex">
						<div>주문내역 검색</div>
						<div class="user-info-box flex-fill"
							style="border-right: 3px solid black; justify-content: left;">
